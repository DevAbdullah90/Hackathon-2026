...
# from app.api.api_v1.endpoints import signals, incidents, simulation, websocket

api_router = APIRouter()

# ---------------------------------------------------------------------------
# Endpoints will be registered here once each file is implemented.
# Example (uncomment as each module is built):
# ---------------------------------------------------------------------------
