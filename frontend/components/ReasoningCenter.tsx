...
const ReasoningCenter: React.FC<Props> = ({ isModal = false, showHeader = true }) => {
          ...
          <View key={step.id} style={styles.stepRow}>
            ...
            <View style={styles.timeline}>
              <View style={[
                ...
                <Ionicons 
                  name={step.status === 'completed' ? "checkmark" : step.status === 'ongoing' ? "sync" : "ellipse"} 
                  size={18} 
                  color={step.status === 'completed' ? "#34D399" : step.status === 'ongoing' ? "#60A5FA" : "#64748B"} 
                />
              </View>
