...
const SimulationView = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setRainfall(prev => Math.max(32, Math.min(82, prev + (Math.random() * 5 - 2.5))));
      setDrainage(prev => Math.max(65, Math.min(96, prev + (Math.random() * 3 - 1.5))));
      setRisk(prev => Math.max(48, Math.min(92, prev + (Math.random() * 6 - 3))));
    }, 2800);
      ...
      <View style={styles.metricsRow}>
        ...
        <View style={styles.metricBox}>
          ...
          <View style={styles.smallProgressBg}>
            <View style={[styles.smallProgress, { width: `${rainfall}%`, backgroundColor: '#60A5FA' }]} />
          </View>
        </View>
        ...
        <View style={styles.metricBox}>
          ...
          <View style={styles.smallProgressBg}>
            <View style={[styles.smallProgress, { width: `${drainage}%`, backgroundColor: '#34D399' }]} />
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  riskLevel: { color: '#EF4444', fontSize: 14, fontWeight: '700', marginTop: 4 },
